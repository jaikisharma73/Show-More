...
const MovieCard = ({movie}) => {
  ...
  return (
    <div className=' flex flex-col justify-between p-2 sm:p-3 bg-gray-800 rounded-2xl hover:translate-y-1 transition duration-300 w-full sm:w-64' >
        <img onClick={()=>{ navigate(`/movies/${movie._id}`);scrollTo(0,0) }} 
        src={image_base_url+movie.backdrop_path} alt="" className='rounded-lg h-36 sm:h-52 w-full object-cover object-right-bottom cursor-pointer' />
