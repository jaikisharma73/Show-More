import { CardSimIcon, ChartLineIcon, CircleDollarSignIcon, PlayCircleIcon, StarIcon, UserIcon } from 'lucide-react';
...
const Dashboard = () =>{
    ...
    return !loading ?(
        <>
            ...
            <div className='relative flex flex-wrap gap-3 mt-4 max-w-5xl'>
