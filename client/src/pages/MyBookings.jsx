...
const MyBookings = () => {
  ...
  return !isLoading ? (
    <div className="relative px-6 md:px-16 lg:px-20 pt-30 md:pt-40 min-h-[80vh]">
      ...
      {bookings.map((item, index) => (
        ...
        <div className="flex flex-col md:items-end md:text-right justify-between p-4">
          <div className="flex items-center gap-4">
            ...
            {item.isPaid && <span className="bg-green-500 text-white px-4 py-1.5 mb-3 text-sm rounded-full font-medium whitespace-nowrap">Paid</span>}
          </div>
          <div className="text-sm">
            <p><span className="text-gray-400">
Total Tickets:</span>{item.bookedSeats.length} </p>
